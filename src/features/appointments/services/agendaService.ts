...
function normalizeAgendaItem(raw: any): AgendaItem {
  return {
    ...
    cliente:            raw.cliente            ?? raw.Cliente           ?? raw.clienteNombre    ?? raw.ClienteNombre    ?? raw.nombreCliente ?? raw.NombreCliente ?? '',
    documentoEmpleado:  raw.documentoEmpleado  ?? raw.DocumentoEmpleado ?? '',
    empleado:           raw.empleado           ?? raw.Empleado          ?? raw.empleadoNombre   ?? raw.EmpleadoNombre   ?? raw.nombreEmpleado ?? raw.NombreEmpleado ?? '',
